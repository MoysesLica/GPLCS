...
public class DiffBetweenModelsController {
	...
	public static void generateDiffBT0KHM1(Vector<String> headings, 
        ...
        switch(parameterCalc){
            case "Propagation Constant":
            	DiffBetweenModelsController.generateDiffBT0KHM1PropagationConstant(headings, model1, model2, x, axisScale, BT0AgainstKHM1);
                break;
            case "Characteristic Impedance":
            	DiffBetweenModelsController.generateDiffBT0KHM1CharacteristicImpedance(headings, model1, model2, x, axisScale, BT0AgainstKHM1);
                break;
            case "Transfer Function":
            	DiffBetweenModelsController.generateDiffBT0KHM1TransferFunction(headings, model1, model2, x, axisScale, BT0AgainstKHM1);
                break;
            case "Primary Parameters":
            	DiffBetweenModelsController.generateDiffBT0KHM1PrimaryParameters(headings, model1, model2, x, axisScale, BT0AgainstKHM1);
                break;
            default:
	...
	public static void generateDiffBT0KHM1PropagationConstant(Vector<String> headings, Vector<BT0> models1,
			Vector<KHM1> models2, Vector<Double> x, String axisScale, boolean BT0AgainstKHM1) {
        ...
        for(int i = 0; i < models1.size(); i++) {
        	...
        	Vector<Double> addToAlpha = models1.get(i).generateAttenuationConstant(x);
        	Vector<Double> addToBeta = models1.get(i).generatePhaseConstant(x);
        ...
        for(int i = 0; i < models2.size(); i++) {
        	...
        	Vector<Double> addToAlpha = models2.get(i).generateAlphaPropagationConstant(x);
        	Vector<Double> addToBeta = models2.get(i).generateBetaPropagationConstant(x);
        ...
        try {
	        ...
	        if(BT0AgainstKHM1) {
		        chart.setTitle("Propagation Constant - Difference between BT0 Model and KH Model 1");	        	
	        }else {
		        chart.setTitle("Propagation Constant - Difference between KH Model 1 and BT0 Model");	        		        	
	        }
        } catch (Exception e) {
			e.printStackTrace();
		}
	...
	private static void generateDiffBT0KHM1CharacteristicImpedance(Vector<String> headings, Vector<BT0> models1, Vector<KHM1> models2, Vector<Double> x,
			String axisScale, boolean BT0AgainstKHM1) {
    	/*GET THE SCREEN HEIGHT AND WIDTH TO CREATE WINDOW*/
        int screenWidth  = (int)Toolkit.getDefaultToolkit().getScreenSize().getWidth()/100;
        int screenHeight = (int)Toolkit.getDefaultToolkit().getScreenSize().getHeight()/100;
        ...
        try {
	        ...
	        chart.getIcons().add(image);
	        if(BT0AgainstKHM1) {
		        chart.setTitle("Characteristic Impedance - Difference between BT0 Model and KH Model 1");	        	
	        }else {
		        chart.setTitle("Characteristic Impedance - Difference between KH Model 1 and BT0 Model");	        		        	
	        }
        } catch (Exception e) {
	...
	private static void generateDiffBT0KHM1TransferFunction(Vector<String> headings, Vector<BT0> models1, Vector<KHM1> models2, Vector<Double> x,
			String axisScale, boolean BT0AgainstKHM1) {
        ...
        try {
	        ...
	        chart.getIcons().add(image);
	        if(BT0AgainstKHM1) {
		        chart.setTitle("Transfer Function - Difference between BT0 Model and KH Model 1");	        	
	        }else {
		        chart.setTitle("Transfer Function - Difference between KH Model 1 and BT0 Model");	        		        	
	        }	        
        } catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
    ...
    private static void generateDiffBT0KHM1PrimaryParameters(Vector<String> headings, Vector<BT0> models1, Vector<KHM1> models2, Vector<Double> x,
			String axisScale, boolean BT0AgainstKHM1) {
        ...
        try {
	        ...
	        chart.getIcons().add(image);
	        if(BT0AgainstKHM1) {
		        chart.setTitle("Primary Parameters - Difference between BT0 Model and KH Model 1");	        	
	        }else {
		        chart.setTitle("Primary Parameters - Difference between KH Model 1 and BT0 Model");	        		        	
	        }
	...
	public static void generateDiffBT0TNO(Vector<String> headings, Vector<Double> Z0inf, Vector<Double> nVF, Vector<Double> Rs0, Vector<Double> qL,
        ...
        switch(parameterCalc){
            case "Propagation Constant":
            	DiffBetweenModelsController.generateDiffBT0TNOPropagationConstant(headings, model1, model2, x, axisScale, BT0AgainstTNO);
                break;
            case "Characteristic Impedance":
            	DiffBetweenModelsController.generateDiffBT0TNOCharacteristicImpedance(headings, model1, model2, x, axisScale, BT0AgainstTNO);
                break;
            case "Transfer Function":
            	DiffBetweenModelsController.generateDiffBT0TNOTransferFunction(headings, model1, model2, x, axisScale, BT0AgainstTNO);
                break;
            case "Primary Parameters":
            	DiffBetweenModelsController.generateDiffBT0TNOPrimaryParameters(headings, model1, model2, x, axisScale, BT0AgainstTNO);
                break;
            default:
                    Alert alert = new Alert(Alert.AlertType.ERROR);
                    alert.setTitle("Error");
	...
	public static void generateDiffBT0TNOPropagationConstant(Vector<String> headings, Vector<BT0> models1,
			Vector<TNO_EAB> models2, Vector<Double> x, String axisScale, boolean BT0AgainstTNO) {
		/*GET THE SCREEN HEIGHT AND WIDTH TO CREATE WINDOW*/
        int screenWidth  = (int)Toolkit.getDefaultToolkit().getScreenSize().getWidth()/100;
        int screenHeight = (int)Toolkit.getDefaultToolkit().getScreenSize().getHeight()/100;
        ...
        if(BT0AgainstTNO) {
        	complement += "(BT0 - TNO/EAB)";
        }else {
        	complement += "(TNO/EAB - BT0)";        	
        }
        ...
        try {
	        ...
	        chart.getIcons().add(image);
	        if(BT0AgainstTNO) {
		        chart.setTitle("Propagation Constant - Difference between BT0 Model and TNO/EAB Model");	        	
	        }else {
		        chart.setTitle("Propagation Constant - Difference between TNO/EAB Model and BT0 Model");	        		        	
	        }
        } catch (Exception e) {
			e.printStackTrace();
		}
	...
	private static void generateDiffBT0TNOCharacteristicImpedance(Vector<String> headings, Vector<BT0> models1, Vector<TNO_EAB> models2, Vector<Double> x,
			String axisScale, boolean BT0AgainstTNO) {
    	/*GET THE SCREEN HEIGHT AND WIDTH TO CREATE WINDOW*/
        int screenWidth  = (int)Toolkit.getDefaultToolkit().getScreenSize().getWidth()/100;
        int screenHeight = (int)Toolkit.getDefaultToolkit().getScreenSize().getHeight()/100;
        ...
        try {
	        ...
	        chart.getIcons().add(image);
	        if(BT0AgainstTNO) {
		        chart.setTitle("Characteristic Impedance - Difference between BT0 Model and TNO/EAB Model");	        	
	        }else {
		        chart.setTitle("Characteristic Impedance - Difference between TNO/EAB Model and BT0 Model");	        		        	
	        }
        } catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	private static void generateDiffBT0TNOTransferFunction(Vector<String> headings, Vector<BT0> models1, Vector<TNO_EAB> models2, Vector<Double> x,
			String axisScale, boolean BT0AgainstTNO) {
        ...
        try {
	        ...
	        chart.getIcons().add(image);
	        if(BT0AgainstTNO) {
		        chart.setTitle("Transfer Function - Difference between BT0 Model and TNO/EAB Model");	        	
	        }else {
		        chart.setTitle("Transfer Function - Difference between TNO/EAB Model and BT0 Model");	        		        	
	        }	        
        } catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
    ...
    private static void generateDiffBT0TNOPrimaryParameters(Vector<String> headings, Vector<BT0> models1, Vector<TNO_EAB> models2, Vector<Double> x,
			String axisScale, boolean BT0AgainstTNO) {
        ...
        try {
	        ...
	        chart.getIcons().add(image);
	        if(BT0AgainstTNO) {
		        chart.setTitle("Primary Parameters - Difference between BT0 Model and TNO/EAB Model");	        	
	        }else {
		        chart.setTitle("Primary Parameters - Difference between TNO/EAB Model and BT0 Model");	        		        	
	        }
    ...
    public static void generateDiffKHM1TNO(Vector<String> headings, Vector<Double> Z0inf, Vector<Double> nVF, Vector<Double> Rs0, Vector<Double> qL,
        ...
        switch(parameterCalc){
            case "Propagation Constant":
            	DiffBetweenModelsController.generateDiffKHM1TNOPropagationConstant(headings, model1, model2, x, axisScale, KHM1AgainstTNO);
                break;
            case "Characteristic Impedance":
            	DiffBetweenModelsController.generateDiffKHM1TNOCharacteristicImpedance(headings, model1, model2, x, axisScale, KHM1AgainstTNO);
                break;
            case "Transfer Function":
            	DiffBetweenModelsController.generateDiffKHM1TNOTransferFunction(headings, model1, model2, x, axisScale, KHM1AgainstTNO);
                break;
            case "Primary Parameters":
            	DiffBetweenModelsController.generateDiffKHM1TNOPrimaryParameters(headings, model1, model2, x, axisScale, KHM1AgainstTNO);
                break;
            default:
                    Alert alert = new Alert(Alert.AlertType.ERROR);
                    alert.setTitle("Error");
	...
	public static void generateDiffKHM1TNOPropagationConstant(Vector<String> headings, Vector<KHM1> models1,
			Vector<TNO_EAB> models2, Vector<Double> x, String axisScale, boolean KHM1AgainstTNO) {
		/*GET THE SCREEN HEIGHT AND WIDTH TO CREATE WINDOW*/
        int screenWidth  = (int)Toolkit.getDefaultToolkit().getScreenSize().getWidth()/100;
        int screenHeight = (int)Toolkit.getDefaultToolkit().getScreenSize().getHeight()/100;
        ...
        if(KHM1AgainstTNO) {
        	complement += "(KHM1 - TNO/EAB)";
        }else {
        	complement += "(TNO/EAB - KHM1)";        	
        }
        ...
        try {
	        ...
	        if(KHM1AgainstTNO) {
		        ...
		        chart.setTitle("Propagation Constant - Difference between TNO/EAB Model and KH Model 1");	        		        	
	        }
        } catch (Exception e) {
			e.printStackTrace();
		}
	...
	private static void generateDiffKHM1TNOCharacteristicImpedance(Vector<String> headings, Vector<KHM1> models1, Vector<TNO_EAB> models2, Vector<Double> x,
			String axisScale, boolean KHM1AgainstTNO) {
    	/*GET THE SCREEN HEIGHT AND WIDTH TO CREATE WINDOW*/
        int screenWidth  = (int)Toolkit.getDefaultToolkit().getScreenSize().getWidth()/100;
        int screenHeight = (int)Toolkit.getDefaultToolkit().getScreenSize().getHeight()/100;
        ...
        try {
	        ...
	        if(KHM1AgainstTNO) {
		        ...
		        chart.setTitle("Characteristic Impedance - Difference between TNO/EAB Model and KH Model 1");	        		        	
	        }
        } catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	private static void generateDiffKHM1TNOTransferFunction(Vector<String> headings, Vector<KHM1> models1, Vector<TNO_EAB> models2, Vector<Double> x,
        ...
        try {
	        ...
	        if(KHM1AgainstTNO) {
		        ...
		        chart.setTitle("Transfer Function - Difference between TNO/EAB Model and KH Model 1");	        		        	
	        }	        
        } catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
    ...
    private static void generateDiffKHM1TNOPrimaryParameters(Vector<String> headings, Vector<KHM1> models1, Vector<TNO_EAB> models2, Vector<Double> x,
        ...
        try {
	        ...
	        if(KHM1AgainstTNO) {
		        ...
		        chart.setTitle("Primary Parameters - Difference between TNO/EAB Model and KH Model 1");	        		        	
	        }
