...
public class KHM2Controller {
	...
	public static void generateOutputFile(double k1, double k2, double k3, double h1, double h2, double cableLength, double minF, double maxF, double toneSpacing, String axisScale, String parameterCalc, File file) throws FileNotFoundException {
        ...
        KHM2 model = new KHM2(k1,k2,k3,h1,h2,cableLength);
	...
	public static void generatePropagationConstant(KHM2 model, Vector<Double> x, String axisScale) {
	...
	public static void generatePropagationConstant(Vector<String> headings, Vector<KHM2> models, Vector<Double> x, String axisScale) {
        ...
        for(int i = 0; i < models.size(); i++) {
        	...
        	Vector<Double> addToAlpha = ((KHM2)models.get(i)).generateAlphaPropagationConstant(x);
        	Vector<Double> addToBeta = ((KHM2)models.get(i)).generateBetaPropagationConstant(x);
        	
        	alpha.add(addToAlpha);
        	beta.add(addToBeta);
        	gama.add(((KHM2)models.get(i)).generatePropagationConstant(x, addToAlpha, addToBeta));
        }
	...
	public static void generateCharacteristicImpedance(KHM2 model, Vector<Double> x, String axisScale) {
	...
	public static void generateCharacteristicImpedance(Vector<String> headings, Vector<KHM2> models, Vector<Double> x, String axisScale) {
        ...
        for(int i = 0; i < models.size(); i++) {
        	...
        	Vector<Double> addToReal = ((KHM2)models.get(i)).generateRealCharacteristicImpedance(x);
        	Vector<Double> addToImag = ((KHM2)models.get(i)).generateImagCharacteristicImpedance(x);
        	
        	real.add(addToReal);
        	imag.add(addToImag);
        	CI.add(((KHM2)models.get(i)).generateCharacteristicImpedance(x, addToReal, addToImag));
        }
	...
	public static void generateTransferFunction(KHM2 model, Vector<Double> x, String axisScale) {
	...
	public static void generateTransferFunction(Vector<String> headings, Vector<KHM2> models, Vector<Double> x, String axisScale) {
	...
	public static void generateGraphs(double k1, double k2, double k3, double h1, double h2, double cableLength, double minF, double maxF, double toneSpacing, String axisScale, String parameterCalc){
        ...
        switch(parameterCalc){
            case "Propagation Constant":
            	KHM2Controller.generatePropagationConstant(model, x, axisScale);
                break;
            case "Characteristic Impedance":
            	KHM2Controller.generateCharacteristicImpedance(model, x, axisScale);
                break;
            case "Transfer Function":
            	KHM2Controller.generateTransferFunction(model, x, axisScale);
                break;
            case "Primary Parameters":
            	KHM2Controller.generatePrimaryParameters(model, x, axisScale);
                break;
            default:
                    Alert alert = new Alert(Alert.AlertType.ERROR);
                    alert.setTitle("Error");
	...
	private static void generatePrimaryParameters(KHM2 model, Vector<Double> x, String axisScale) {
    ...
    public static void generateGraphs(Vector<String> headings, Vector<Double> k1, Vector<Double> k2, Vector<Double> k3, Vector<Double> h1, Vector<Double> h2, double cableLength, double minF, double maxF, double toneSpacing, String axisScale, String parameterCalc){
        ...
        /*CREATE THE CABLE MODEL*/
        Vector<KHM2> models = new Vector<KHM2>();
        for(int i = 0; i < headings.size(); i++) {
            KHM2 model = new KHM2(k1.get(i),k2.get(i),k3.get(i),h1.get(i),h2.get(i),cableLength);        	
            models.add(model);
        }
        ...
        switch(parameterCalc){
            case "Propagation Constant":
            	KHM2Controller.generatePropagationConstant(headings, models, x, axisScale);
                break;
            case "Characteristic Impedance":
            	KHM2Controller.generateCharacteristicImpedance(headings, models, x, axisScale);
                break;
            case "Transfer Function":
            	KHM2Controller.generateTransferFunction(headings, models, x, axisScale);
                break;
            case "Primary Parameters":
            	KHM2Controller.generatePrimaryParameters(headings, models, x, axisScale);
                break;
            default:
                    Alert alert = new Alert(Alert.AlertType.ERROR);
                    alert.setTitle("Error");
	...
	private static void generatePrimaryParameters(Vector<String> headings, Vector<KHM2> models, Vector<Double> x, String axisScale) {
