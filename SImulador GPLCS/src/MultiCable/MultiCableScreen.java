...
public class MultiCableScreen {
	...
	public static GridPane getMultiCableScreen(Stage primaryStage, String transmissionLineModel) {
            ...
            public void handle(MouseEvent me) {
        		...
        		switch(topology.getValue().getText().split(",")[0]) {
            		...
            		case "Topology 8(1)":
        				...
        				bridgeTap.add(new Double(4));
        				data.add(config.get(1));
        				data.add(config.get(5));
        				bridgeTap.add(new Double(5));
        				data.add(config.get(2));
        				data.add(config.get(3));
            			break;
            		...
            		case "Topology 9":
        				...
        				bridgeTap.add(new Double(5));
        				data.add(config.get(2));
        				data.add(config.get(6));
        				bridgeTap.add(new Double(6));
        				data.add(config.get(3));
            			break;
		...
		grid.add(networkRegion, 0, line + 1, 5, 1);
	...
	public static void generateConfiguration4_1(
			Group networkRegion, Rectangle networkRegionBorder, Stage primaryStage,
	        Vector<GenericCableModel> config, Vector<Text> cableText, Vector<Line> cableSegment, String transmissionLineModel
			) {
	...
	public static void generateConfiguration4_2(
			Group networkRegion, Rectangle networkRegionBorder, Stage primaryStage,
	        Vector<GenericCableModel> config, Vector<Text> cableText, Vector<Line> cableSegment, String transmissionLineModel
			) {
		...
		double[] posBridge1 = {posLine2[2], (Ye - Ys)/2, posLine2[2] , (Ye - Ys)/2 + tamLine};
	...
	public static void generateConfiguration6(
			Group networkRegion, Rectangle networkRegionBorder, Stage primaryStage,
	        Vector<GenericCableModel> config, Vector<Text> cableText, Vector<Line> cableSegment, String transmissionLineModel
			) {
		...
		double[] posLine2 = {posLine1[2], (Ye - Ys)/2, posLine1[2] + tamLine, (Ye - Ys)/2};
		double[] posLine3 = {posLine2[2], (Ye - Ys)/2, posLine2[2] + tamLine, (Ye - Ys)/2};
		double[] posLine4 = {posLine3[2], (Ye - Ys)/2, posLine3[2] + tamLine, (Ye - Ys)/2};
		...
		MultiCableScreen.generateStandardLine(
				posLine3, Color.BLUE, primaryStage, networkRegion, config, cableText, cableSegment, 0, transmissionLineModel);		
		MultiCableScreen.generateStandardLine(
				posLine4, Color.BLUE, primaryStage, networkRegion, config, cableText, cableSegment, 0, transmissionLineModel);
		...
		double[] posPoint3 = { posLine3[0] , posLine3[1] };
		double[] posPoint4 = { posLine3[2] , posLine3[3] };
		double[] posPoint5 = { posLine4[2] , posLine4[3] };

		MultiCableScreen.generateStandardPoint(posPoint1, Color.RED, networkRegion, "Start Point");
		MultiCableScreen.generateStandardPoint(posPoint2, Color.BLACK, networkRegion, "");
		MultiCableScreen.generateStandardPoint(posPoint3, Color.BLACK, networkRegion, "");		
		MultiCableScreen.generateStandardPoint(posPoint4, Color.BLACK, networkRegion, "");
		MultiCableScreen.generateStandardPoint(posPoint5, Color.PURPLE, networkRegion, "End Point");
		
	}

	public static void generateConfiguration7_1(
			Group networkRegion, Rectangle networkRegionBorder, Stage primaryStage,
	        Vector<GenericCableModel> config, Vector<Text> cableText, Vector<Line> cableSegment, String transmissionLineModel
			) {
		...
		double[] posPointBridge1 = { posBridge1[2] , posBridge1[3] };
		...
		MultiCableScreen.generateStandardPoint(posPointBridge1, Color.GOLD, networkRegion, "Bridge Tap");
		
	}

	public static void generateConfiguration7_2(
			Group networkRegion, Rectangle networkRegionBorder, Stage primaryStage,
	        Vector<GenericCableModel> config, Vector<Text> cableText, Vector<Line> cableSegment, String transmissionLineModel
			) {
	...
	public static void generateConfiguration7_3(
			Group networkRegion, Rectangle networkRegionBorder, Stage primaryStage,
	        Vector<GenericCableModel> config, Vector<Text> cableText, Vector<Line> cableSegment, String transmissionLineModel
			) {
		...
		double[] posBridge1 = {posLine3[2], (Ye - Ys)/2, posLine3[2] , (Ye - Ys)/2 + tamLine};
	...
	public static void generateConfiguration8_1(
			Group networkRegion, Rectangle networkRegionBorder, Stage primaryStage,
	        Vector<GenericCableModel> config, Vector<Text> cableText, Vector<Line> cableSegment, String transmissionLineModel
			) {
		...
		double[] posPointBridge1 = { posBridge1[2] , posBridge1[3] };
		double[] posPointBridge2 = { posBridge2[2] , posBridge2[3] };
		...
		MultiCableScreen.generateStandardPoint(posPointBridge1, Color.GOLD, networkRegion, "Bridge Tap");
		MultiCableScreen.generateStandardPoint(posPointBridge2, Color.GOLD, networkRegion, "Bridge Tap");
		
	}

	public static void generateConfiguration8_2(
			Group networkRegion, Rectangle networkRegionBorder, Stage primaryStage,
	        Vector<GenericCableModel> config, Vector<Text> cableText, Vector<Line> cableSegment, String transmissionLineModel
			) {
		...
		double[] posBridge1 = {posLine1[2], (Ye - Ys)/2, posLine1[2] , (Ye - Ys)/2 + tamLine};
		double[] posBridge2 = {posLine3[2], (Ye - Ys)/2, posLine3[2] , (Ye - Ys)/2 + tamLine};
	...
	public static void generateConfiguration8_3(
			Group networkRegion, Rectangle networkRegionBorder, Stage primaryStage,
	        Vector<GenericCableModel> config, Vector<Text> cableText, Vector<Line> cableSegment, String transmissionLineModel
			) {
	...
	public static void generateConfiguration9(
			Group networkRegion, Rectangle networkRegionBorder, Stage primaryStage,
	        Vector<GenericCableModel> config, Vector<Text> cableText, Vector<Line> cableSegment, String transmissionLineModel
			) {
		...
		double[] posBridge1 = {posLine1[2], (Ye - Ys)/2, posLine1[2] , (Ye - Ys)/2 + tamLine};
		double[] posBridge2 = {posLine2[2], (Ye - Ys)/2, posLine2[2] , (Ye - Ys)/2 + tamLine};
		double[] posBridge3 = {posLine3[2], (Ye - Ys)/2, posLine3[2] , (Ye - Ys)/2 + tamLine};
		...
		MultiCableScreen.generateStandardLineWithOffsetOnText(
				posBridge2, Color.BLUE, primaryStage, networkRegion, config, cableText, cableSegment, -90, transmissionLineModel);
		MultiCableScreen.generateStandardLineWithOffsetOnText(
				posBridge3, Color.BLUE, primaryStage, networkRegion, config, cableText, cableSegment, -90, transmissionLineModel);
		...
		double[] posPointBridge1 = { posBridge1[2] , posBridge1[3] };
		double[] posPointBridge2 = { posBridge2[2] , posBridge2[3] };
		double[] posPointBridge3 = { posBridge3[2] , posBridge3[3] };
		...
		MultiCableScreen.generateStandardPoint(posPointBridge1, Color.GOLD, networkRegion, "Bridge Tap");
		MultiCableScreen.generateStandardPoint(posPointBridge2, Color.GOLD, networkRegion, "Bridge Tap");
		MultiCableScreen.generateStandardPoint(posPointBridge3, Color.GOLD, networkRegion, "Bridge Tap");
		
	}

	public static void generateConfiguration10(
			Group networkRegion, Rectangle networkRegionBorder, Stage primaryStage,
	        Vector<GenericCableModel> config, Vector<Text> cableText, Vector<Line> cableSegment, String transmissionLineModel
			) {
		...
		double[] posLine3 = {posLine2[2], (Ye - Ys)/2, posLine2[2] + tamLine, (Ye - Ys)/2};
		double[] posLine4 = {posLine3[2], (Ye - Ys)/2, posLine3[2] + tamLine, (Ye - Ys)/2};
		double[] posLine5 = {posLine4[2], (Ye - Ys)/2, posLine4[2] + tamLine, (Ye - Ys)/2};
		...
		MultiCableScreen.generateStandardLine(
				posLine4, Color.BLUE, primaryStage, networkRegion, config, cableText, cableSegment, 0, transmissionLineModel);
		MultiCableScreen.generateStandardLine(
				posLine5, Color.BLUE, primaryStage, networkRegion, config, cableText, cableSegment, 0, transmissionLineModel);
		...
		double[] posPoint4 = { posLine3[2] , posLine3[3] };
		double[] posPoint5 = { posLine4[2] , posLine4[3] };
		double[] posPoint6 = { posLine5[2] , posLine5[3] };

		MultiCableScreen.generateStandardPoint(posPoint1, Color.RED, networkRegion, "Start Point");
		MultiCableScreen.generateStandardPoint(posPoint2, Color.BLACK, networkRegion, "");
		MultiCableScreen.generateStandardPoint(posPoint3, Color.BLACK, networkRegion, "");		
		MultiCableScreen.generateStandardPoint(posPoint4, Color.BLACK, networkRegion, "");
		MultiCableScreen.generateStandardPoint(posPoint5, Color.BLACK, networkRegion, "");
		MultiCableScreen.generateStandardPoint(posPoint6, Color.PURPLE, networkRegion, "End Point");

		
	}

	public static void generateConfiguration11_1(
			Group networkRegion, Rectangle networkRegionBorder, Stage primaryStage,
	        Vector<GenericCableModel> config, Vector<Text> cableText, Vector<Line> cableSegment, String transmissionLineModel
			) {
	...
	public static void generateConfiguration11_2(
			Group networkRegion, Rectangle networkRegionBorder, Stage primaryStage,
	        Vector<GenericCableModel> config, Vector<Text> cableText, Vector<Line> cableSegment, String transmissionLineModel
			) {
	...
	public static void generateConfiguration11_3(
			Group networkRegion, Rectangle networkRegionBorder, Stage primaryStage,
	        Vector<GenericCableModel> config, Vector<Text> cableText, Vector<Line> cableSegment, String transmissionLineModel
			) {
	...
	public static void generateConfiguration11_4(
			Group networkRegion, Rectangle networkRegionBorder, Stage primaryStage,
	        Vector<GenericCableModel> config, Vector<Text> cableText, Vector<Line> cableSegment, String transmissionLineModel
			) {
		...
		double[] posBridge1 = {posLine4[2], (Ye - Ys)/2, posLine4[2] , (Ye - Ys)/2 + tamLine};
	...
	public static void configComboBoxConfigurations(JFXComboBox<Label> topology, Group networkRegion, Vector<GenericCableModel> config, Vector<Text> cableText, Vector<Line> cableSegment, Rectangle networkRegionBorder, Stage primaryStage, String transmissionLineModel) {
        ...
        topology.getItems().add(new Label("Topology 4(1), three segments with 1 bridge tap"));
        topology.getItems().add(new Label("Topology 4(2), three segments with 1 bridge tap"));
        topology.getItems().add(new Label("Topology 5, three segments with 2 bridge tap"));
        topology.getItems().add(new Label("Topology 6, four segments"));
        topology.getItems().add(new Label("Topology 7(1), four segments with 1 bridge tap"));
        topology.getItems().add(new Label("Topology 7(2), four segments with 1 bridge tap"));
        topology.getItems().add(new Label("Topology 7(3), four segments with 1 bridge tap"));
        topology.getItems().add(new Label("Topology 8(1), four segments with 2 bridge tap"));
        topology.getItems().add(new Label("Topology 8(2), four segments with 2 bridge tap"));
        topology.getItems().add(new Label("Topology 8(3), four segments with 2 bridge tap"));
        topology.getItems().add(new Label("Topology 9, four segments with 3 bridge tap"));
        topology.getItems().add(new Label("Topology 10, five segments"));
        topology.getItems().add(new Label("Topology 11(1), five segments with 1 bridge tap"));
        topology.getItems().add(new Label("Topology 11(2), five segments with 1 bridge tap"));
        topology.getItems().add(new Label("Topology 11(3), five segments with 1 bridge tap"));
        topology.getItems().add(new Label("Topology 11(4), five segments with 1 bridge tap"));
        ...
        topology.valueProperty().addListener(new ChangeListener<Label>() {
            ...
            public void changed(ObservableValue<? extends Label> observable, Label oldValue, Label newValue) {
            	...
            	switch(newValue.getText().split(",")[0]) {
            		...
            		case "Topology 4(1)":
            			MultiCableScreen.generateConfiguration4_1(
            					networkRegion, networkRegionBorder, primaryStage, config, cableText, cableSegment, transmissionLineModel);
            			break;

            		case "Topology 4(2)":
            			MultiCableScreen.generateConfiguration4_2(
            					networkRegion, networkRegionBorder, primaryStage, config, cableText, cableSegment, transmissionLineModel);
            			break;
            		...
            		case "Topology 6":
            			MultiCableScreen.generateConfiguration6(
            					networkRegion, networkRegionBorder, primaryStage, config, cableText, cableSegment, transmissionLineModel);
            			break;

            		case "Topology 7(1)":
            			MultiCableScreen.generateConfiguration7_1(
            					networkRegion, networkRegionBorder, primaryStage, config, cableText, cableSegment, transmissionLineModel);
            			break;

            		case "Topology 7(2)":
            			MultiCableScreen.generateConfiguration7_2(
            			            					networkRegion, networkRegionBorder, primaryStage, config, cableText, cableSegment, transmissionLineModel);
            			break;

            		case "Topology 7(3)":
            			MultiCableScreen.generateConfiguration7_3(
            				networkRegion, networkRegionBorder, primaryStage, config, cableText, cableSegment, transmissionLineModel);
            			break;

            		case "Topology 8(1)":
            			MultiCableScreen.generateConfiguration8_1(
            				networkRegion, networkRegionBorder, primaryStage, config, cableText, cableSegment, transmissionLineModel);
            			break;

            		case "Topology 8(2)":
            			MultiCableScreen.generateConfiguration8_2(
            				networkRegion, networkRegionBorder, primaryStage, config, cableText, cableSegment, transmissionLineModel);
            			break;

            		case "Topology 8(3)":
            			MultiCableScreen.generateConfiguration8_3(
            				networkRegion, networkRegionBorder, primaryStage, config, cableText, cableSegment, transmissionLineModel);
            			break;

            		case "Topology 9":
            			MultiCableScreen.generateConfiguration9(
            				networkRegion, networkRegionBorder, primaryStage, config, cableText, cableSegment, transmissionLineModel);
            			break;

            		case "Topology 10":
            			MultiCableScreen.generateConfiguration10(
            				networkRegion, networkRegionBorder, primaryStage, config, cableText, cableSegment, transmissionLineModel);
            			break;

            		case "Topology 11(1)":
            			MultiCableScreen.generateConfiguration11_1(
            				networkRegion, networkRegionBorder, primaryStage, config, cableText, cableSegment, transmissionLineModel);
            			break;

            		case "Topology 11(2)":
            			MultiCableScreen.generateConfiguration11_2(
            				networkRegion, networkRegionBorder, primaryStage, config, cableText, cableSegment, transmissionLineModel);
            			break;

            		case "Topology 11(3)":
            			MultiCableScreen.generateConfiguration11_3(
            				networkRegion, networkRegionBorder, primaryStage, config, cableText, cableSegment, transmissionLineModel);
            			break;

            		case "Topology 11(4)":
            			MultiCableScreen.generateConfiguration11_4(
            				networkRegion, networkRegionBorder, primaryStage, config, cableText, cableSegment, transmissionLineModel);
            			break;
